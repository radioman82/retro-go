...
void S9xInitDSP(void) {
  switch (Settings.DSP) {
  case 1: /* DSP1 */
    DSP1 = rg_alloc(sizeof(*DSP1), MEM_SLOW);
    SetDSP = &DSP1SetByte;
    GetDSP = &DSP1GetByte;
    break;
  case 2: /* DSP2 */
    DSP2 = rg_alloc(sizeof(*DSP2), MEM_SLOW);
    SetDSP = &DSP2SetByte;
    GetDSP = &DSP2GetByte;
    break;
  case 3: /* DSP3 */
    DSP3 = rg_alloc(sizeof(*DSP3), MEM_SLOW);
    SetDSP = &DSP3SetByte;
    GetDSP = &DSP3GetByte;
    break;
  case 4: /* DSP4 */
    DSP4 = rg_alloc(sizeof(*DSP4), MEM_SLOW);
    SetDSP = &DSP4SetByte;
    GetDSP = &DSP4GetByte;
    break;
  default:
...
uint8_t S9xGetDSP(uint16_t address) { return ((*GetDSP)(address)); }

void S9xSetDSP(uint8_t byte, uint16_t address) { (*SetDSP)(byte, address); }
...
static void DSP1_Inverse(int16_t Coefficient, int16_t Exponent,
                         int16_t *iCoefficient, int16_t *iExponent) {
...
static void DSP1_Op10(void) {
  DSP1_Inverse(DSP1->Op10Coefficient, DSP1->Op10Exponent,
               &DSP1->Op10CoefficientR, &DSP1->Op10ExponentR);
}
...
static int16_t DSP1_Sin(int16_t Angle) {
  ...
  S = DSP1_SinTable[Angle >> 8] +
      (DSP1_MulTable[Angle & 0xff] * DSP1_SinTable[0x40 + (Angle >> 8)] >> 15);
  if (S > 32767)
    S = 32767;
...
static void DSP1_NormalizeDouble(int32_t Product, int16_t *Coefficient,
                                 int16_t *Exponent) {
  int16_t n, m, i, e;
...
static void DSP1_Op0C(void) {
  DSP1->Op0CX2 = (DSP1->Op0CY1 * DSP1_Sin(DSP1->Op0CA) >> 15) +
                 (DSP1->Op0CX1 * DSP1_Cos(DSP1->Op0CA) >> 15);
  DSP1->Op0CY2 = (DSP1->Op0CY1 * DSP1_Cos(DSP1->Op0CA) >> 15) -
                 (DSP1->Op0CX1 * DSP1_Sin(DSP1->Op0CA) >> 15);
}

static void DSP1_Parameter(int16_t Fx, int16_t Fy, int16_t Fz, int16_t Lfe,
                           int16_t Les, int16_t Aas, int16_t Azs, int16_t *Vof,
                           int16_t *Vva, int16_t *Cx, int16_t *Cy) {
...
static void DSP1_Raster(int16_t Vs, int16_t *An, int16_t *Bn, int16_t *Cn,
                        int16_t *Dn) {
  int16_t C, E, C1, E1;
...
static void DSP1_Op02(void) {
  DSP1_Parameter(DSP1->Op02FX, DSP1->Op02FY, DSP1->Op02FZ, DSP1->Op02LFE,
                 DSP1->Op02LES, DSP1->Op02AAS, DSP1->Op02AZS, &DSP1->Op02VOF,
                 &DSP1->Op02VVA, &DSP1->Op02CX, &DSP1->Op02CY);
}

static void DSP1_Op0A(void) {
  DSP1_Raster(DSP1->Op0AVS, &DSP1->Op0AA, &DSP1->Op0AB, &DSP1->Op0AC,
              &DSP1->Op0AD);
  DSP1->Op0AVS++;
}
...
static void DSP1_Project(int16_t X, int16_t Y, int16_t Z, int16_t *H,
                         int16_t *V, int16_t *M) {
  int32_t aux, aux4;
  int16_t E, E2, E3, E4, E5, refE, E6, E7;
  int16_t C2, C4, C6, C8, C9, C10, C11, C12, C16, C17, C18, C19, C20, C21, C22,
      C23, C24, C25, C26;
  int16_t Px, Py, Pz;
  ...
  aux = ((uint16_t)DSP1->G_Les) + aux4; /* Les - the scalar product of P with
                                           the normal vector of the screen*/
  ...
  C17 = C16 + C20; /* scalar product of P with the normalized horizontal vector
                      of the screen...*/
  ...
  *H = DSP1_Truncate(C19, DSP1->E_Les - E2 + refE + E7);
  ...
  C24 = C21 + C22 + C23; /* scalar product of P with the normalized vertical
                            vector of the screen...*/
  ...
  *M = DSP1_Truncate(C6, E4 + DSP1->E_Les - E2 -
                             7); /* M is the scale factor divided by 2^7*/
}

static void DSP1_Op06(void) {
  DSP1_Project(DSP1->Op06X, DSP1->Op06Y, DSP1->Op06Z, &DSP1->Op06H,
               &DSP1->Op06V, &DSP1->Op06M);
}
...
static void DSP1_Op01(void) {
  ...
  DSP1->matrixA[1][0] =
      ((DSP1->Op01m * SinAz >> 15) * CosAx >> 15) +
      (((DSP1->Op01m * CosAz >> 15) * SinAx >> 15) * SinAy >> 15);
  DSP1->matrixA[1][1] =
      ((DSP1->Op01m * CosAz >> 15) * CosAx >> 15) -
      (((DSP1->Op01m * SinAz >> 15) * SinAx >> 15) * SinAy >> 15);
  DSP1->matrixA[1][2] = -((DSP1->Op01m * SinAx >> 15) * CosAy >> 15);

  DSP1->matrixA[2][0] =
      ((DSP1->Op01m * SinAz >> 15) * SinAx >> 15) -
      (((DSP1->Op01m * CosAz >> 15) * CosAx >> 15) * SinAy >> 15);
  DSP1->matrixA[2][1] =
      ((DSP1->Op01m * CosAz >> 15) * SinAx >> 15) +
      (((DSP1->Op01m * SinAz >> 15) * CosAx >> 15) * SinAy >> 15);
...
static void DSP1_Op11(void) {
  ...
  DSP1->matrixB[1][0] =
      ((DSP1->Op11m * SinAz >> 15) * CosAx >> 15) +
      (((DSP1->Op11m * CosAz >> 15) * SinAx >> 15) * SinAy >> 15);
  DSP1->matrixB[1][1] =
      ((DSP1->Op11m * CosAz >> 15) * CosAx >> 15) -
      (((DSP1->Op11m * SinAz >> 15) * SinAx >> 15) * SinAy >> 15);
  DSP1->matrixB[1][2] = -((DSP1->Op11m * SinAx >> 15) * CosAy >> 15);

  DSP1->matrixB[2][0] =
      ((DSP1->Op11m * SinAz >> 15) * SinAx >> 15) -
      (((DSP1->Op11m * CosAz >> 15) * CosAx >> 15) * SinAy >> 15);
  DSP1->matrixB[2][1] =
      ((DSP1->Op11m * CosAz >> 15) * SinAx >> 15) +
      (((DSP1->Op11m * SinAz >> 15) * CosAx >> 15) * SinAy >> 15);
...
static void DSP1_Op21(void) {
  ...
  DSP1->matrixC[1][0] =
      ((DSP1->Op21m * SinAz >> 15) * CosAx >> 15) +
      (((DSP1->Op21m * CosAz >> 15) * SinAx >> 15) * SinAy >> 15);
  DSP1->matrixC[1][1] =
      ((DSP1->Op21m * CosAz >> 15) * CosAx >> 15) -
      (((DSP1->Op21m * SinAz >> 15) * SinAx >> 15) * SinAy >> 15);
  DSP1->matrixC[1][2] = -((DSP1->Op21m * SinAx >> 15) * CosAy >> 15);

  DSP1->matrixC[2][0] =
      ((DSP1->Op21m * SinAz >> 15) * SinAx >> 15) -
      (((DSP1->Op21m * CosAz >> 15) * CosAx >> 15) * SinAy >> 15);
  DSP1->matrixC[2][1] =
      ((DSP1->Op21m * CosAz >> 15) * SinAx >> 15) +
      (((DSP1->Op21m * SinAz >> 15) * CosAx >> 15) * SinAy >> 15);
  DSP1->matrixC[2][2] = (DSP1->Op21m * CosAx >> 15) * CosAy >> 15;
}

static void DSP1_Op0D(void) {
  DSP1->Op0DF = (DSP1->Op0DX * DSP1->matrixA[0][0] >> 15) +
                (DSP1->Op0DY * DSP1->matrixA[0][1] >> 15) +
                (DSP1->Op0DZ * DSP1->matrixA[0][2] >> 15);
  DSP1->Op0DL = (DSP1->Op0DX * DSP1->matrixA[1][0] >> 15) +
                (DSP1->Op0DY * DSP1->matrixA[1][1] >> 15) +
                (DSP1->Op0DZ * DSP1->matrixA[1][2] >> 15);
  DSP1->Op0DU = (DSP1->Op0DX * DSP1->matrixA[2][0] >> 15) +
                (DSP1->Op0DY * DSP1->matrixA[2][1] >> 15) +
                (DSP1->Op0DZ * DSP1->matrixA[2][2] >> 15);
}

static void DSP1_Op1D(void) {
  DSP1->Op1DF = (DSP1->Op1DX * DSP1->matrixB[0][0] >> 15) +
                (DSP1->Op1DY * DSP1->matrixB[0][1] >> 15) +
                (DSP1->Op1DZ * DSP1->matrixB[0][2] >> 15);
  DSP1->Op1DL = (DSP1->Op1DX * DSP1->matrixB[1][0] >> 15) +
                (DSP1->Op1DY * DSP1->matrixB[1][1] >> 15) +
                (DSP1->Op1DZ * DSP1->matrixB[1][2] >> 15);
  DSP1->Op1DU = (DSP1->Op1DX * DSP1->matrixB[2][0] >> 15) +
                (DSP1->Op1DY * DSP1->matrixB[2][1] >> 15) +
                (DSP1->Op1DZ * DSP1->matrixB[2][2] >> 15);
}

static void DSP1_Op2D(void) {
  DSP1->Op2DF = (DSP1->Op2DX * DSP1->matrixC[0][0] >> 15) +
                (DSP1->Op2DY * DSP1->matrixC[0][1] >> 15) +
                (DSP1->Op2DZ * DSP1->matrixC[0][2] >> 15);
  DSP1->Op2DL = (DSP1->Op2DX * DSP1->matrixC[1][0] >> 15) +
                (DSP1->Op2DY * DSP1->matrixC[1][1] >> 15) +
                (DSP1->Op2DZ * DSP1->matrixC[1][2] >> 15);
  DSP1->Op2DU = (DSP1->Op2DX * DSP1->matrixC[2][0] >> 15) +
                (DSP1->Op2DY * DSP1->matrixC[2][1] >> 15) +
                (DSP1->Op2DZ * DSP1->matrixC[2][2] >> 15);
}

static void DSP1_Op03(void) {
  DSP1->Op03X = (DSP1->Op03F * DSP1->matrixA[0][0] >> 15) +
                (DSP1->Op03L * DSP1->matrixA[1][0] >> 15) +
                (DSP1->Op03U * DSP1->matrixA[2][0] >> 15);
  DSP1->Op03Y = (DSP1->Op03F * DSP1->matrixA[0][1] >> 15) +
                (DSP1->Op03L * DSP1->matrixA[1][1] >> 15) +
                (DSP1->Op03U * DSP1->matrixA[2][1] >> 15);
  DSP1->Op03Z = (DSP1->Op03F * DSP1->matrixA[0][2] >> 15) +
                (DSP1->Op03L * DSP1->matrixA[1][2] >> 15) +
                (DSP1->Op03U * DSP1->matrixA[2][2] >> 15);
}

static void DSP1_Op13(void) {
  DSP1->Op13X = (DSP1->Op13F * DSP1->matrixB[0][0] >> 15) +
                (DSP1->Op13L * DSP1->matrixB[1][0] >> 15) +
                (DSP1->Op13U * DSP1->matrixB[2][0] >> 15);
  DSP1->Op13Y = (DSP1->Op13F * DSP1->matrixB[0][1] >> 15) +
                (DSP1->Op13L * DSP1->matrixB[1][1] >> 15) +
                (DSP1->Op13U * DSP1->matrixB[2][1] >> 15);
  DSP1->Op13Z = (DSP1->Op13F * DSP1->matrixB[0][2] >> 15) +
                (DSP1->Op13L * DSP1->matrixB[1][2] >> 15) +
                (DSP1->Op13U * DSP1->matrixB[2][2] >> 15);
}

static void DSP1_Op23(void) {
  DSP1->Op23X = (DSP1->Op23F * DSP1->matrixC[0][0] >> 15) +
                (DSP1->Op23L * DSP1->matrixC[1][0] >> 15) +
                (DSP1->Op23U * DSP1->matrixC[2][0] >> 15);
  DSP1->Op23Y = (DSP1->Op23F * DSP1->matrixC[0][1] >> 15) +
                (DSP1->Op23L * DSP1->matrixC[1][1] >> 15) +
                (DSP1->Op23U * DSP1->matrixC[2][1] >> 15);
  DSP1->Op23Z = (DSP1->Op23F * DSP1->matrixC[0][2] >> 15) +
                (DSP1->Op23L * DSP1->matrixC[1][2] >> 15) +
                (DSP1->Op23U * DSP1->matrixC[2][2] >> 15);
}
...
static void DSP1_Op14(void) {
  ...
  /* Rotation Around Z*/
  DSP1_NormalizeDouble(DSP1->Op14U * DSP1_Cos(DSP1->Op14Yr) -
                           DSP1->Op14F * DSP1_Sin(DSP1->Op14Yr),
                       &C, &E);
  ...
  /* Rotation Around X*/
  DSP1->Op14Xrr = DSP1->Op14Xr + (DSP1->Op14U * DSP1_Sin(DSP1->Op14Yr) >> 15) +
                  (DSP1->Op14F * DSP1_Cos(DSP1->Op14Yr) >> 15);
...
static void DSP1_Op0B(void) {
  DSP1->Op0BS =
      (DSP1->Op0BX * DSP1->matrixA[0][0] + DSP1->Op0BY * DSP1->matrixA[0][1] +
       DSP1->Op0BZ * DSP1->matrixA[0][2]) >>
      15;
}

static void DSP1_Op1B(void) {
  DSP1->Op1BS =
      (DSP1->Op1BX * DSP1->matrixB[0][0] + DSP1->Op1BY * DSP1->matrixB[0][1] +
       DSP1->Op1BZ * DSP1->matrixB[0][2]) >>
      15;
}

static void DSP1_Op2B(void) {
  DSP1->Op2BS =
      (DSP1->Op2BX * DSP1->matrixC[0][0] + DSP1->Op2BY * DSP1->matrixC[0][1] +
       DSP1->Op2BZ * DSP1->matrixC[0][2]) >>
      15;
}

static void DSP1_Op08(void) {
  int32_t op08Size = (DSP1->Op08X * DSP1->Op08X + DSP1->Op08Y * DSP1->Op08Y +
                      DSP1->Op08Z * DSP1->Op08Z)
                     << 1;
...
static void DSP1_Op18(void) {
  DSP1->Op18D = (DSP1->Op18X * DSP1->Op18X + DSP1->Op18Y * DSP1->Op18Y +
                 DSP1->Op18Z * DSP1->Op18Z - DSP1->Op18R * DSP1->Op18R) >>
                15;
}

static void DSP1_Op38(void) {
  DSP1->Op38D = (DSP1->Op38X * DSP1->Op38X + DSP1->Op38Y * DSP1->Op38Y +
                 DSP1->Op38Z * DSP1->Op38Z - DSP1->Op38R * DSP1->Op38R) >>
                15;
  DSP1->Op38D++;
}

static void DSP1_Op28(void) {
  int32_t Radius = DSP1->Op28X * DSP1->Op28X + DSP1->Op28Y * DSP1->Op28Y +
                   DSP1->Op28Z * DSP1->Op28Z;
...
static void DSP1_Op1C(void) {
  ...
  DSP1->Op1CX1 = (DSP1->Op1CYBR * DSP1_Sin(DSP1->Op1CZ) >> 15) +
                 (DSP1->Op1CXBR * DSP1_Cos(DSP1->Op1CZ) >> 15);
  DSP1->Op1CY1 = (DSP1->Op1CYBR * DSP1_Cos(DSP1->Op1CZ) >> 15) -
                 (DSP1->Op1CXBR * DSP1_Sin(DSP1->Op1CZ) >> 15);
  DSP1->Op1CXBR = DSP1->Op1CX1;
  DSP1->Op1CYBR = DSP1->Op1CY1;

  /* Rotate Around Op1CY1*/
  DSP1->Op1CZ1 = (DSP1->Op1CXBR * DSP1_Sin(DSP1->Op1CY) >> 15) +
                 (DSP1->Op1CZBR * DSP1_Cos(DSP1->Op1CY) >> 15);
  DSP1->Op1CX1 = (DSP1->Op1CXBR * DSP1_Cos(DSP1->Op1CY) >> 15) -
                 (DSP1->Op1CZBR * DSP1_Sin(DSP1->Op1CY) >> 15);
  DSP1->Op1CXAR = DSP1->Op1CX1;
  DSP1->Op1CZBR = DSP1->Op1CZ1;

  /* Rotate Around Op1CX1*/
  DSP1->Op1CY1 = (DSP1->Op1CZBR * DSP1_Sin(DSP1->Op1CX) >> 15) +
                 (DSP1->Op1CYBR * DSP1_Cos(DSP1->Op1CX) >> 15);
  DSP1->Op1CZ1 = (DSP1->Op1CZBR * DSP1_Cos(DSP1->Op1CX) >> 15) -
                 (DSP1->Op1CYBR * DSP1_Sin(DSP1->Op1CX) >> 15);
  DSP1->Op1CYAR = DSP1->Op1CY1;
  DSP1->Op1CZAR = DSP1->Op1CZ1;
}

static void DSP1_Op0F(void) { DSP1->Op0FPass = 0x0000; }
    ...
    if (DSP1->waiting4command || (DSP1->first_parameter && byte == 0x80)) {
      ...
      if (DSP1->in_count) {
        if (--DSP1->in_count == 0) {
          ...
          case 0x00: /* Multiple*/
            DSP1->Op00Multiplicand =
                (int16_t)(DSP1->parameters[0] | (DSP1->parameters[1] << 8));
            DSP1->Op00Multiplier =
                (int16_t)(DSP1->parameters[2] | (DSP1->parameters[3] << 8));
          ...
          case 0x10: /* Inverse*/
            ...
            DSP1->out_count = 4;
            DSP1->output[0] =
                (uint8_t)(((int16_t)DSP1->Op10CoefficientR) & 0xFF);
            DSP1->output[1] =
                (uint8_t)((((int16_t)DSP1->Op10CoefficientR) >> 8) & 0xFF);
            DSP1->output[2] = (uint8_t)(((int16_t)DSP1->Op10ExponentR) & 0xFF);
            DSP1->output[3] =
                (uint8_t)((((int16_t)DSP1->Op10ExponentR) >> 8) & 0xFF);
            break;
          ...
          case 0x04: /* Sin and Cos of angle*/
            DSP1->Op04Angle =
                (int16_t)(DSP1->parameters[0] | (DSP1->parameters[1] << 8));
            DSP1->Op04Radius =
                (uint16_t)(DSP1->parameters[2] | (DSP1->parameters[3] << 8));
          ...
          case 0x08: /* Radius*/
            ...
            DSP1->Op08Y =
                (int16_t)(DSP1->parameters[2] | (DSP1->parameters[3] << 8));
            DSP1->Op08Z =
                (int16_t)(DSP1->parameters[4] | (DSP1->parameters[5] << 8));
          ...
          case 0x18: /* Range*/
            ...
            DSP1->Op18Z =
                (int16_t)(DSP1->parameters[4] | (DSP1->parameters[5] << 8));
            DSP1->Op18R =
                (int16_t)(DSP1->parameters[6] | (DSP1->parameters[7] << 8));
          ...
          case 0x1c: /* Polar (3D rotate)*/
            ...
            DSP1->Op1CZBR =
                (DSP1->parameters[10] | (DSP1->parameters[11] << 8));
          ...
          case 0x02: /* Parameter (Projection)*/
            ...
            DSP1->Op02LFE =
                (int16_t)(DSP1->parameters[6] | (DSP1->parameters[7] << 8));
            DSP1->Op02LES =
                (int16_t)(DSP1->parameters[8] | (DSP1->parameters[9] << 8));
            DSP1->Op02AAS =
                (uint16_t)(DSP1->parameters[10] | (DSP1->parameters[11] << 8));
            DSP1->Op02AZS =
                (uint16_t)(DSP1->parameters[12] | (DSP1->parameters[13] << 8));
          ...
          case 0x14:
            ...
            DSP1->Op14F =
                (int16_t)(DSP1->parameters[8] | (DSP1->parameters[9] << 8));
            DSP1->Op14L =
                (int16_t)(DSP1->parameters[10] | (DSP1->parameters[11] << 8));
...
static void DSP2_Op01(void) {
  ...
  for (j = 0; j < 8; j++) {
    ...
    *p2a++ = (c0 & 0x10) << 3 | (c0 & 0x01) << 6 | (c1 & 0x10) << 1 |
    ...
    *p2b++ = (c0 & 0x40) << 1 | (c0 & 0x04) << 4 | (c1 & 0x40) >> 1 |
...
static void DSP2_Op0D (void)
{
        ...
        for (int32_t i = 0; i < DSP2->Op0DOutLen * 2; i++)
        {
                ...
                if ((pixel_offset & 1) == 0)
                        pixelarray[i] = DSP2->parameters[pixel_offset >> 1] >>
4; else pixelarray[i] = DSP2->parameters[pixel_offset >> 1] & 0x0f;
        }

        for (int32_t i = 0; i < DSP2->Op0DOutLen; i++)
                DSP2->output[i] = (pixelarray[i << 1] << 4) | pixelarray[(i <<
1) + 1];
}
*/
  ...
  while (DSP3->op1e_lcv_radius < DSP3->op1e_max_radius) {
    ...
    while (DSP3->op1e_lcv_turns) {
      ...
      while (DSP3->op1e_lcv_steps) {
        ...
        if (0 <= DSP3->op1e_y && DSP3->op1e_y < DSP3->WinHi &&
            0 <= DSP3->op1e_x && DSP3->op1e_x < DSP3->WinLo) {
          DSP3->DR = (uint8_t)(DSP3->op1e_x) | ((uint8_t)(DSP3->op1e_y) << 8);
          DSP3_OP03();

          DSP3->op1e_cell = DSP3->DR;
          if (DSP3->op1e_cost[DSP3->op1e_cell] < 0x80 &&
              DSP3->op1e_terrain[DSP3->op1e_cell] < 0x40)
...
static void DSP3_OP1E_B2(void) {
  ...
  if (path != 0xff)
    DSP3->op1e_weight[DSP3->op1e_cell] =
        path + DSP3->op1e_cost[DSP3->op1e_cell];
}
...
static void DSP3_OP1E_D1(int16_t move, int16_t *lo, int16_t *hi) {
  static const uint16_t HiAdd[] = {0x00, 0xFF, 0x00, 0x01, 0x01, 0x01,
                                   0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00,
                                   0x01, 0x00, 0xFF, 0x00};

  static const uint16_t LoAdd[] = {0x00, 0x00, 0x01, 0x01,
                                   0x00, 0xFF, 0xFF, 0x00};
...
static void DSP4_Multiply(int16_t Multiplicand, int16_t Multiplier,
                          int32_t *Product) {
...
static void DSP4_OP01(void) {
  ...
  do {
    ...
    DSP4->view_x2 =
        (((DSP4->world_x + DSP4->world_xenv) >> 16) * DSP4->distance >> 15) +
        (DSP4->view_turnoff_x * DSP4->distance >> 15);
    DSP4->view_y2 = (DSP4->world_y >> 16) * DSP4->distance >> 15;
    DSP4->view_xofs2 = DSP4->view_x2;
    DSP4->view_yofs2 = (DSP4->world_yofs * DSP4->distance >> 15) +
                       DSP4->poly_bottom[0][0] - DSP4->view_y2;
    ...
    if (DSP4->segments) {
      ...
      px_dx =
          (DSP4->view_xofs2 - DSP4->view_xofs1) * DSP4_Inverse(DSP4->segments)
          << 1;
      py_dy =
          (DSP4->view_yofs2 - DSP4->view_yofs1) * DSP4_Inverse(DSP4->segments)
          << 1;

      /* starting step values*/
      x_scroll = DSP_SEX16(DSP4->poly_cx[0][0] + DSP4->view_xofs1);
      y_scroll = DSP_SEX16(-DSP4->viewport_bottom + DSP4->view_yofs1 +
                           DSP4->view_yofsenv + DSP4->poly_cx[1][0] -
                           DSP4->world_yofs);
  ...
  resume2:
    ...
    for (polygon = 0; polygon < 2; polygon++) {
      ...
      if (DSP4->segments) {
        ...
        w_left = DSP_SEX16(DSP4->poly_cx[polygon][0] - DSP4->poly_start[poly] +
                           env[0][0]);
        w_right = DSP_SEX16(DSP4->poly_cx[polygon][1] - DSP4->poly_start[poly] +
                            env[1][0]);
...
static void DSP4_OP0B(bool *draw, int16_t sp_x, int16_t sp_y, int16_t sp_attr,
                      bool size, bool stop) {
  int16_t Row1, Row2;
  ...
  if (*draw) {
    ...
    DSP4->OAM_attr[DSP4->OAM_index] |=
        ((sp_x < 0 || sp_x > 255) << DSP4->OAM_bits);
    DSP4->OAM_bits++;
...
static void DSP4_OP09(void) {
  ...
  resume1:
    ...
    if (DSP4->raster < DSP4->poly_raster[0][0]) {
      DSP4->sprite_clipy =
          DSP4->viewport_bottom - (DSP4->poly_bottom[0][0] - DSP4->raster);
    ...
    resume2:
      ...
      DSP4->sprite_y =
          DSP4->viewport_bottom - (DSP4->poly_bottom[0][0] - view_spy);
    ...
    resume5:
      ...
      if (header != 0x20 && header != 0x2e && /* This is for attractor sprite*/
          header != 0x40 && header != 0x60 && header != 0xa0 &&
          header != 0xc0 && header != 0xe0)
        break;
    ...
    resume6:
      ...
      if (DSP4->sprite_clipy - pixels <= sp_y && sp_y <= DSP4->sprite_clipy &&
          sp_x >= DSP4->viewport_left - pixels &&
          sp_x <= DSP4->viewport_right &&
          DSP4->sprite_clipy >= DSP4->viewport_top - pixels &&
          DSP4->sprite_clipy <= DSP4->viewport_bottom)
        DSP4_OP0B(&draw, sp_x, DSP4->sprite_clipy, 0x00EE, DSP4->sprite_size,
                  0);

      /* normal sprite tile*/
      if (sp_x >= DSP4->viewport_left - pixels &&
          sp_x <= DSP4->viewport_right && sp_y >= DSP4->viewport_top - pixels &&
          sp_y <= DSP4->viewport_bottom && sp_y <= DSP4->sprite_clipy)
...
static void DSP4_OP0A(int16_t n2, int16_t *o1, int16_t *o2, int16_t *o3,
                      int16_t *o4) {
